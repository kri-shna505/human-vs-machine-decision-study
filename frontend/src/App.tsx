  ...
  return (
    <span className="brand-mark" aria-hidden="true">
      ...
      >
        ...
        {/* Internal brain and circuit lines. */}
        <path
...
function App() {
  ...
  /**
   * Check whether the FastAPI backend is reachable when the page loads.
   */
  useEffect(() => {
    let isMounted = true;
    ...
    <div className="app" id="top">
      ...
      <header className="site-header">
        <div className="header-content">
          {/* Brand link returns the page to the top. */}
          <a className="brand" href="#top" aria-label="Decision Study home">
            <BrainLogo />
      ...
      <main>
        ...
        <section className="hero">
          ...
          {/*
            A healthy backend produces no visible message.
            Users see an error only when FastAPI cannot be reached.
          */}
        ...
        {/* Decision-making scenarios section. */}
        <section
